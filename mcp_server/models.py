...
class CertificateParameters(BaseModel):
    ...
    Membership_No: str = Field(
        ..., description='Membership No.', examples=['ACS 128XX']
    )
...
class CertificateParameters1(BaseModel):
    CertType: str = Field(
        ..., description='Type of Certificate', examples=['ACS,FCS,COP']
    )
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    Membership_No: str = Field(..., description='Membership No.', examples=['128XX'])


class MbcerCertificatePostRequest(BaseModel):
...
class MbcerCertificatePostResponse(BaseModel):
...
class MbcerCertificatePostResponse1(BaseModel):
...
class MbcerCertificatePostResponse2(BaseModel):
...
class MbcerCertificatePostResponse3(BaseModel):
...
class MbcerCertificatePostResponse4(BaseModel):
...
class MbcerCertificatePostResponse5(BaseModel):
...
class MbcerCertificatePostResponse6(BaseModel):
